...
const LoadProceduresCodeGenerator = () => {
    /**
    ...
    Blockly.Arduino['procedures_defreturn'] = function (block) {
        ...
        // console.log("procedures.js-29; branch:\n"+ branch);
    ...
    Blockly.Arduino['procedures_argument'] = function(block) {
        let argName = block.getFieldValue('NAME');
        argName = Blockly.Arduino.variableDB_.getName(
          argName,
          Blockly.Variables.NAME_TYPE
        );
    ...
    Blockly.Arduino['procedures_return'] = function (block) {
        const code = 'return ' + (Blockly.Arduino.valueToCode(block, 'VALUE', Blockly.Arduino.ORDER_NONE) || 0) + ';\n';
        return code;
    };
    /**
...
export default LoadProceduresCodeGenerator;
