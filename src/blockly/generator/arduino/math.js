...
const LoadMathCodeGenerator = () => {
        ...
        switch (dropdown_property) {
            ...
            case 'DIVISIBLE_BY':
                var divisor = Blockly.Arduino.valueToCode(block, 'DIVISOR',
                    Blockly.Arduino.ORDER_MULTIPLICATIVE) || '0';
                code = divisor + ' % ' + number_to_check + ' == 0';
                break;
        }
    ...
    Blockly.Arduino['math_change'] = function (block) {
        ...
        console.log('math_changemath_change');
    ...
    Blockly.Arduino['math_max_min'] = function (block) {
        var operator = block.getFieldValue('OP');

        var arg1 = Blockly.Arduino.valueToCode(block, 'NUM1', Blockly.Arduino.ORDER_NONE) || '0';
        var arg2 = Blockly.Arduino.valueToCode(block, 'NUM2', Blockly.Arduino.ORDER_NONE) || '0';
