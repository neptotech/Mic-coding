...
const LoadTextBlocks = () => {
    ...
    Blockly.Blocks['text'] = {
        ...
        /** set limitation of input length, max length is 40 */
        onchange: function () {
            var text_content = this.getFieldValue("TEXT");
            if (text_content.length > 40) {
                this.setFieldValue(text_content.substring(0, 40), "TEXT")
            }
        }
    };
