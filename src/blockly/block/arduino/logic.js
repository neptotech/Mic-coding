...
const LoadLogicBlocks = () => {
    ...
    Blockly.Blocks['controls_if'] = {
        ...
        init: function () {
            ...
            this.setColour(Blockly.Msg.LogicHUE);
    ...
    **/
    Blockly.Blocks['switch_statement'] = {
        init: function () {
            this.appendDummyInput()
                .appendField(Blockly.Msg.LOGIC_SWITCH)
                .appendField(new Blockly.FieldVariable("var"), "switch_var");
            this.appendValueInput('CASE0')
                .setCheck(['Text', 'Number'])
                .appendField(Blockly.Msg.LOGIC_CASE);
            this.appendStatementInput("DO0")
                .setCheck(null)
                .appendField(Blockly.Msg.LOGIC_DO);
         ...
         */
        decompose: function (workspace) {
            var containerBlock = workspace.newBlock('controls_switch_statement');
            containerBlock.initSvg();
            var connection = containerBlock.nextConnection;
        ...
        updateShape_: function () {
            ...
            if (this.defaultCount_) {
                this.appendStatementInput('DEFAULT')
                    .appendField(Blockly.Msg.LOGIC_DEFAULT);
            }
        }
    };

    Blockly.Blocks['controls_switch_statement'] = {
        /**
         * Mutator block for if container.
         * @this Blockly.Block
         */
