...
const LoadMathBlocks = () => {
    ...
    Blockly.Blocks['math_number'] = {
        ...
        onchange: function () {
            ...
            var text_content = this.getFieldValue("NUM");
            if (text_content.length > 15) {
                this.setFieldValue(text_content.substring(0, 50), "NUM")
            }
        }
    };
    ...
    Blockly.Blocks['math_trig'] = {
        ...
        init: function () {
            this.jsonInit({
                ...
                "output": Blockly.Types.DECIMAL.output,
                "colour": Blockly.Msg.VariablesHUE,
    ...
    Blockly.Blocks['math_max_min'] = {
        ...
        init: function () {
            this.jsonInit({
                ...
                "output": Blockly.Types.DECIMAL.output,
                "colour": Blockly.Msg.MathHUE,
                "tooltip": Blockly.Msg.MATH_MAX_MIN_TOOLTIP,
                "helpUrl": Blockly.Msg.MATH_MAX_MIN_HELPURL
            });
        },
        /** @return {!string} Type of the block, round always returns a float. */
        getBlockType: function () {
    ...
    Blockly.Blocks['math_random_seed'] = {
        ...
        init: function () {
            this.jsonInit({
                "message0": Blockly.Msg.MATH_RANDOM_SEED,
                "args0": [{
                    "type": "input_value",
                    "name": "SEED",
                    "check": Blockly.Types.NUMBER.checkList
